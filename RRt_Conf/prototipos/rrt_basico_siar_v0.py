...
from rrt_basico_siar import RRT_SIAR, tabla_configuraciones, calcular_largo
...
def main():
    ...
    ax.set_title("Arbol RRT con nodos generados")
    ax.axis("off")
    plt.pause(2)
    ...
    for i, nodo in enumerate(trayecto):
        ...
        ax.set_title(f"Configuracion paso {i}")
        ax.axis("off")
        plt.pause(1.0)
